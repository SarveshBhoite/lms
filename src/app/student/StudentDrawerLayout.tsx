...
export default function StudentDrawerLayout({
  ...
  // Total aggregated badges count for hamburger icon
  const totalBadgesCount =
    unreadNotificationsCount + liveClassesCount + quizzesCount + assignmentsCount;
  ...
  const navigation = [
    ...
    { name: "Notifications", href: "/student/notifications", icon: Bell, badge: unreadNotificationsCount },
  ...
  return (
    <div className="min-h-screen h-screen portal-bg-mesh flex flex-col md:flex-row selection:bg-purple-500 selection:text-white relative overflow-hidden">
      ...
      {/* SIDEBAR / DRAWER:
          ...
          - Mobile: fixed drawer sliding in from the left (w-72 or w-64) with high z-index
      */}
      <aside
                ...
                return (
                  ...
                  >
                    ...
                    {item.badge !== undefined && item.badge > 0 ? (
                      <span className="px-2 py-0.5 rounded-full bg-rose-600 text-white font-mono text-[10px] font-bold shadow-xs">
